...
public class LvJavaApplicationTests extends TestCase {
	...
	public void testCadastraAcesso() {
		...
		acesso.setDescricao("ROLE_ADMIN_FOI3");
		...
		assertEquals("ROLE_ADMIN_FOI3", acesso.getDescricao());
		...
		acesso.setDescricao("ROLE_PROF");
		
		acesso = acessoController.salvarAcesso(acesso).getBody();
		
		List<Acesso> acessos = acessoRepository.buscarAcessoDesc("PROF".trim().toUpperCase());
